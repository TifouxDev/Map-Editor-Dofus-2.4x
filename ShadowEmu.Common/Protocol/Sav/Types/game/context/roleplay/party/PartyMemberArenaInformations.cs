...
public PartyMemberArenaInformations(double id, string name, byte level, Types.EntityLook entityLook, sbyte breed, bool sex, uint lifePoints, uint maxLifePoints, uint prospecting, byte regenRate, uint initiative, sbyte alignmentSide, short worldX, short worldY, int mapId, uint subAreaId, Types.PlayerStatus status, Types.PartyCompanionMemberInformations[] companions, uint rank)
