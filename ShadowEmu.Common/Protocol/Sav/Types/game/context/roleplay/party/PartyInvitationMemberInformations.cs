...
public PartyInvitationMemberInformations(double id, string name, byte level, Types.EntityLook entityLook, sbyte breed, bool sex, short worldX, short worldY, int mapId, uint subAreaId, Types.PartyCompanionBaseInformations[] companions)
